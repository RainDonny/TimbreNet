...
def whisper_encoder(audio_paths): # get 1024 (for medium), here we use tiny so it's 384
...
def extract_whisper_features(dataset, dataset_type, batch_size=80):
    ...
    # Mapping to mcep's !!!!!lengths!!!!!!! NOT DIMENSIONS
...
if __name__ == "__main__":
    print("Loading Model...")
    model = whisper.load_model("tiny") # default medium
